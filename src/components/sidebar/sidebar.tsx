        ...
        <div className="sidebar">
            ...
            <div className="sidebar-menu-content">
                <div
                    ...
                    onClick={(): void => history.push('/audio')}
                >
                ...
                <div
                    className="sidebar-menu-item"
                    onClick={(): void => history.push('/generator')}
                >
                ...
                <div
                    className="sidebar-menu-item"
                    onClick={(): void => history.push('/statistics')}
                >
                ...
                <div
                    className="sidebar-menu-item"
                    onClick={(): Window =>
                        window.open('https://www.earsbuzzing.com')
                    }
                >
                ...
                <div
                    className="sidebar-menu-item"
                    onClick={(): void => history.push('/tutorial')}
                >
